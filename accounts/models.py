...
class Journey(models.Model):
    ...
    duration_hours = models.PositiveIntegerField(null=True, validators=[MinValueValidator(0), MaxValueValidator(23)])
    duration_minutes = models.PositiveIntegerField(null=True, validators=[MinValueValidator(0), MaxValueValidator(59)])
    date_created = models.DateTimeField(auto_now_add=True, null=True)
